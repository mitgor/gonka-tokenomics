...
Every parameter includes: name, value, unit, source reference, confidence, and format.
...
REQ-U10: Source references per assumption.
REQ-D04: Assumption audit trail with source + confidence.
"""
...
PARAM_GROUPS = OrderedDict([
    ...
    ("TOKEN SUPPLY", [
        ...
        },
        {
            ...
            "value": 680_000_000,
            "unit": "GNK",
            "source": "Whitepaper, 68% allocation",
            "confidence": "HIGH",
            "format": "tokens",
        },
        {
            ...
            "value": 120_000_000,
            "unit": "GNK",
            "source": "Whitepaper, 12% allocation",
            "confidence": "HIGH",
            "format": "tokens",
        },
        {
            ...
            "value": 200_000_000,
            "unit": "GNK",
            "source": "Whitepaper, 20% allocation",
            "confidence": "HIGH",
            "format": "tokens",
        },
    ]),
    ...
    ("PRICE SCENARIOS", [
        {
            ...
            "value": 0.50,
            "unit": "USD",
            "source": "Macro Research, price scenarios",
            "confidence": "MED",
            "format": "currency",
        },
        {
        ...
        },
        {
            ...
            "value": 0.60,
            "unit": "USD",
            "source": "Deep Analysis, Bitfury analysis",
            "confidence": "MED",
            "format": "currency",
        },
    ]),
    ...
    ("FEE TRANSITION", [
        {
            ...
            "value": 36000,
            "unit": "USD/yr",
            "source": "Fine-Tuning Recs, Rec #4 ($3K/mo avg)",
            "confidence": "HIGH",
            "format": "currency",
        },
        {
    ...
    ("GPU ECONOMICS", [
        ...
        },
        {
            ...
            "value": 0.40,
            "unit": "annual",
            "source": "Deep Analysis, GPU deflation",
            "confidence": "MED",
            "format": "percent",
        },
        {
            ...
            "value": 2.25,
            "unit": "USD/hr",
            "source": "Fine-Tuning Recs, Rec #5 (balanced)",
            "confidence": "HIGH",
            "format": "price_per_hour",
        },
    ]),
    ...
    ("HOST ECONOMICS", [
        ...
        },
        {
            ...
            "value": 2.49,
            "unit": "USD/hr",
            "source": "Lambda Labs, on-demand Q1 2026",
            "confidence": "MED",
            "format": "price_per_hour",
        },
        {
        ...
        },
        {
            ...
            "value": 400,
            "unit": "watts",
            "source": "H100 specs, inference avg",
            "confidence": "MED",
            "format": "integer",
        },
    ]),
    ...
    ("veGNK PARAMETERS", [
        ...
        },
        {
            ...
            "value": 2.5,
            "unit": "multiplier",
            "source": "Fine-Tuning Recs, Rec #10",
            "confidence": "HIGH",
            "format": "number",
        },
        {
            ...
            "value": 0.425,
            "unit": "of circulating",
            "source": "Fine-Tuning Recs, Rec #6 (midpoint 35-50%)",
            "confidence": "HIGH",
            "format": "percent",
        },
        {
